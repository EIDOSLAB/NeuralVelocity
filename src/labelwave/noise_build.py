...
def dataset_split(train_images, train_labels, noise_rate=0.5, noise_type='sym', random_seed=1, num_classes=10,
                  include_noise=False):
    ...
    if noise_type == 'instance':
        ...
        noisy_labels = get_instance_noisy_label(noise_rate, dataset, targets, num_classes, feature_size, norm_std,
                                                random_seed)
